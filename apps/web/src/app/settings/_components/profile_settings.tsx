    ...
    <div className="min-h-screen bg-gray-50 p-4 pb-24">
      ...
      <div className="mb-4 grid grid-cols-2 gap-3">
        ...
        >
          ...
          <span className="font-medium text-black">アカウント紐付け</span>
        </button>
      ...
      >
        <div className="flex items-center gap-3">
          <div className="flex h-8 w-8 items-center justify-center rounded-full border-2 border-gray-800">
            <span className="text-xl font-bold leading-none text-black">!</span>
          </div>
          <span className="font-medium text-black">PWAとしてダウンロード</span>
        </div>
      ...
      <div className="mb-4 overflow-hidden rounded-2xl bg-gray-100">
        ...
        <div className="flex items-center justify-between border-b border-gray-200 px-6 py-5">
          <span className="font-medium text-black">位置情報の利用許可</span>
          <button
          ...
          >
            <span
              className={`absolute top-1 h-6 w-6 rounded-full bg-white shadow-md transition-transform duration-200 ${
                locationEnabled ? "translate-x-0" : "-translate-x-6"
              }`}
            />
          </button>
        </div>
        ...
        >
          <span className="font-medium text-black">チュートリアルの表示</span>
